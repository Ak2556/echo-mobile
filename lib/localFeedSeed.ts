...
export const LOCAL_SEED_FEED: FeedItem[] = [
  ...
  },
  {
    ...
    isVerified: true,
    postType: 'video',
    prompt: 'What changed when I rebuilt our prototype into a real app?',
    response: '',
  ...
  // Poll post
  {
    ...
    isVerified: true,
    postType: 'poll',
    prompt: 'What most improved your last product build?',
    response: '',
    poll: {
      question: 'What most improved your last product build?',
      options: [
        { id: 'opt_0', text: 'Fast iteration', votes: 148 },
        { id: 'opt_1', text: 'Better test coverage', votes: 112 },
        { id: 'opt_2', text: 'Clearer product scope', votes: 54 },
        { id: 'opt_3', text: 'User feedback', votes: 38 },
      ],
      totalVotes: 352,
