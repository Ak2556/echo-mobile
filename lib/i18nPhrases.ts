...
export const TT_PHRASES: Partial<Record<AppLanguageCode, Record<string, string>>> = {
  hi: {
    ...
    // Pomodoro
    'Pomodoro': 'पोमोडोरो', 'Flow': 'फ़्लो', 'Focus cockpit': 'फ़ोकस कॉकपिट', 'Timer, breaks, streaks.': 'टाइमर, ब्रेक, लय।',
    'Timer': 'टाइमर', 'days': 'दिन', 'Background timer': 'बैकग्राउंड टाइमर', 'Color progress': 'रंग प्रगति',
    'Session proof': 'सत्र प्रमाण', 'Timer Settings': 'टाइमर सेटिंग्स', 'Timer settings': 'टाइमर सेटिंग्स',
    'Focus length': 'फ़ोकस अवधि', 'Short break': 'छोटा ब्रेक', 'Long break': 'लंबा ब्रेक', 'Long break every': 'हर कितने पर लंबा ब्रेक',
    'Daily goal': 'रोज़ का लक्ष्य', 'min': 'मिनट', 'sessions': 'सत्र', 'Auto-start breaks': 'ब्रेक अपने-आप शुरू',
    'Break timer starts the moment focus ends': 'फ़ोकस खत्म होते ही ब्रेक टाइमर शुरू', 'Save Settings': 'सेटिंग्स सहेजें',
    'Settle': 'जमें', 'Build': 'बनाएं', 'Push': 'ज़ोर लगाएं', 'Ship': 'पूरा करें', 'Breathe': 'सांस लें',
    'Reset': 'रीसेट', 'Return': 'वापसी', 'Recover': 'उबरें', 'Reflect': 'सोचें',
    'Ends': 'खत्म', 'Ready': 'तैयार', 'Next': 'अगला', 'today': 'आज', 'Current focus': 'मौजूदा फ़ोकस',
    'Break context': 'ब्रेक संदर्भ', 'Start style': 'शुरुआत का तरीका', 'Locked in': 'लगे हुए', 'm selected': 'मि चुना',
    'Sprint': 'स्प्रिंट', 'Deep': 'गहरा', 'Classic': 'क्लासिक', 'Pace': 'गति', 'goal': 'लक्ष्य', 'auto': 'ऑटो',
    'proof': 'प्रमाण', 'Focus intelligence': 'फ़ोकस इंटेलिजेंस', 'Best lane:': 'सर्वश्रेष्ठ क्षेत्र:', 'm block ready': 'मि ब्लॉक तैयार',
    'Forest': 'जंगल', 'Tree': 'पेड़', 'Sprout': 'अंकुर', 'Seed': 'बीज', 'Focus tree': 'फ़ोकस पेड़',
    'Seed to forest. One focus block at a time.': 'बीज से जंगल तक। एक बार में एक फ़ोकस ब्लॉक।',
    'Focus beats': 'फ़ोकस बीट्स', 'playing': 'चल रहा', 'Relax while focusing': 'फ़ोकस करते हुए आराम करें',
    'ready': 'तैयार', 'Rank': 'रैंक', 'Win': 'जीत', 'left': 'बाकी', 'Elite': 'एलीट', 'Sharp': 'तेज़',
    'Warm': 'गर्म', 'Start': 'शुरुआत', 'Paused': 'रुका', 'What are you focusing on?': 'आप किस पर फ़ोकस कर रहे हैं?',
    'LAST 7 DAYS': 'पिछले 7 दिन', 'focus min today': 'फ़ोकस मिनट आज', 'TODAY': 'आज', 'Focus session': 'फ़ोकस सत्र',
    'Focus becomes visible progress': 'फ़ोकस दिखने वाली प्रगति बनता है',
    'Turn deep work cycles into proof, accountability, and a next-action plan.': 'गहन कार्य चक्रों को प्रमाण, जवाबदेही, और अगली-कार्रवाई योजना में बदलें।',
    'Focus min': 'फ़ोकस मिनट', 'Day streak': 'दिन की लय', 'Daily goal hit': 'रोज़ का लक्ष्य पूरा',
    'Goal': 'लक्ष्य', 'm loaded': 'मि लोड हुआ', 'Focus': 'फ़ोकस', 'Beat could not start on this device': 'इस डिवाइस पर बीट शुरू नहीं हो सकी',
