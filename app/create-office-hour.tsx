      ...
      <ScreenHeader
        ...
        right={
          <AnimatedPressable
            ...
            disabled={!canSubmit}
            style={{ flexDirection: 'row', alignItems: 'center', gap: 5, paddingHorizontal: 14, paddingVertical: 7, marginRight: 6, borderRadius: radius.lg, backgroundColor: canSubmit ? colors.accent : colors.surfaceHover }}
            scaleValue={0.93}
            haptic="medium"
          >
