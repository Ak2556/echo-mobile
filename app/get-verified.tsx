...
export default function GetVerifiedScreen() {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: colors.bg }}>
      <ScreenHeader title={ttx("Get verified")} safeTop />
      ...
      {phase === 'submitting' && (
        <Center>
          ...
          <Text style={{ color: colors.textSecondary, fontSize: 15 }}>{ttx("Checking your selfie…")}</Text>
        </Center>
      )}
