...
const INTENTS = [
  ...
  "dictate",            // args.text: words to put in the composer already on screen
...
Intent rules:
- "navigate": going to a section/screen. args.destination is one of: home, explore, market, chat, messages, you (profile), notifications (alerts), settings, create (compose a post), story, bookmarks (saved), followers, tools (apps), verify, badges, quests, salons. Examples: "होम पर जाओ"→home, "मैसेज खोलो"→messages, "प्रोफाइल दिखाओ"→you, "सेटिंग"→settings, "बुकमार्क"→bookmarks.
...
- "dictate": they are DICTATING words to go into a text box already on screen — a reply, a direct message, a comment. args.text = the dictated CONTENT only, never the command words, kept in the user's own language. Use this rather than create_post when they are answering or replying to something rather than publishing a new echo. Examples: "reply I will be there in ten minutes" -> args.text="I will be there in ten minutes", "लिखो आज नहीं आ पाऊंगा" -> args.text="आज नहीं आ पाऊंगा". Nothing is sent: the app fills the box and the user presses send.
