-- Re-apply avatar storage bucket and owner-scoped policies.
-- Some production environments missed or lost the original avatars policies,
-- causing profile photo uploads to fail with:
